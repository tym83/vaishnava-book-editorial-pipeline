...
(function () {
    ...
    try {
        ...
        var bodyStylesArg = getArg(
            "body_styles",
            "Основной текст,Цитата 1,Цитата 2,Письмо,Источник,Сноска,Список нумерованный 1,Список нумерованный 2,Список ненумерованный 1,Список ненумерованный 2,Перевод шлоки"
        );
